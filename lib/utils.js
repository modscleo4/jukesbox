 ...
 * @return {Promise<*>}
 */
exports.pageEmbed = async function pageEmbed(message, {title, description = ' '}, content, deleteAfter = false) {
    const maxPerPage = 10;
 ...
 */
exports.searchVideo = async function searchVideo(q, {key, part = ['id', 'snippet',], maxResults = 10, order = 'relevance', regionCode = 'br', type = 'video', videoEmbeddable = true}) {
