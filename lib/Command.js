...
export default class Command {
    ...
    async checkVoiceChannel(message) {
        ...
        if (message.member.voice.channel.userLimit && message.member.voice.channel.members.size === message.member.voice.channel.userLimit && !message.guild.me.hasPermission("MOVE_MEMBERS")) {
