...
export default class Command {
    ...
    async checkVoiceChannel({guild, member}) {
        ...
        if (!member.voice.channel.members.find(m => m === guild.members.me) && member?.voice.channel?.userLimit && member?.voice.channel?.members.size === member?.voice.channel?.userLimit && !guild.members.me.hasPermission("MOVE_MEMBERS")) {
